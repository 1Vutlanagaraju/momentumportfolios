    ...
    <div className="font-sans text-gray-900">
      ...
      <section className="bg-gray-50 py-16 px-6 text-center">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md">
            <p className="italic mb-3">“Trustworthy, transparent, and growth-focused.”</p>
            <h4 className="font-bold">– Investor B</h4>
          </div>
        </div>
      </section>
      ...
      <section className="bg-green-700 text-white text-center py-20 px-6">
        <h2 className="text-3xl font-bold mb-6">Ready to Build Wealth with Momentum?</h2>
        <button className="bg-white text-green-700 px-8 py-3 rounded-2xl font-bold shadow-md hover:bg-gray-100">
      ...
      <footer className="bg-blue-900 text-white py-10 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <p className="text-sm">Email: info@momentumportfolios.com</p>
            <p className="text-sm">Phone: +91 98765 43210</p>
            <p className="text-sm">Location: Hyderabad, India</p>
          </div>
          <div>
            <h3 className="font-bold mb-3">Disclaimer</h3>
            <p className="text-sm">Investments are subject to market risks. Past performance is not indicative of future returns.</p>
          </div>
        </div>
        <p className="text-center text-xs mt-6">© 2025 MomentumPortfolios. All Rights Reserved.</p>
      </footer>
    </div>
  );
}
